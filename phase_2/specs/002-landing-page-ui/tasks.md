...
- [ ] T035 [P] [US5] Update LoadingSpinner component for use on buttons at `frontend/src/components/LoadingSpinner.tsx`
...
- [ ] T036 [P] [US5] Create reusable useAsync hook at `frontend/src/lib/useAsync.ts`
...
- [ ] T037 [US5] Update create task button in dashboard at `frontend/src/app/dashboard/page.tsx` (or task form)
  - Use `useAsync` hook for create task API call
...
- [ ] T038 [US5] Update delete task button(s) in dashboard at `frontend/src/app/dashboard/` or task component
  - Use `useAsync` hook for delete task API call
  - While `isLoading`: show `<LoadingSpinner />` in button
  - While `isLoading`: `disabled={true}` on button
...
- [ ] T039 [US5] Style LoadingSpinner for button context in `frontend/src/components/LoadingSpinner.tsx`
